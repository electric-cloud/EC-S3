...
|List Objects in this folder or Include all sub folders? |If selected, all objects in this folder and all sub-folders are included in the list.
|===
...
|Bucket Name |Name of the bucket to create.
|Enable website hosting |If selected, after you enable your bucket for static website hosting, all of your content is accessible to web browsers through the Amazon S3 endpoint for your bucket.
