...
* Improved the **Test Connection** feature in plugin configuration to validate connectivity on the specified resource.

=== 1.2.3

* Added error summaries for procedures that did not have one.
