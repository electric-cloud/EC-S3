...
After the folder is successfully downloaded, ElectricFlow stores the key names and download paths of the objects in the property sheet.(Default location is */myJob/S3Output*.)
...
ElectricFlow stores the key names and the download locations of the objects in property sheet.(Default location is */myJob/S3Output*.)
...
ElectricFlow stores the list of buckets in the property sheet (Default location is */myJob/S3Output*) as follows:
...
ElectricFlow stores the list of all the objects in the folder in the property sheet.(Default location is */myJob/S3Output*.)
...
After a folder is successfully uploaded, ElectricFlow stores the key names and AWS access URLs for the objects in this folder in the property sheet.(Default location is */myJob/S3Output*.)
...
After an object is successfully uploaded, ElectricFlow stores the key name and AWS link to the object in the property sheet.(Default location is */myJob/S3Output*.)
...
After the bucket is successfully configured for static website hosting, ElectricFlow stores the bucket name as a key and Amazon S3 website endpoint for your bucket as a value in the property sheet.(Default location is */myJob/S3Output*.)
...
In ElectricFlow, go to *Administration* > *Plugins* to open the Plugin Manager. Then click *Configure* and enter the values for the parameters in the S3 Configuration page.
