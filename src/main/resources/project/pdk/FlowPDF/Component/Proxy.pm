...
use Data::Dumper;
use FlowPDF::Log;
use FlowPDF::Helpers qw/isLegacyPerl/;
...
# ## private
# # This function returns whether the perl is legacy or new.
# # The way of handling the proxy settings is completely different
# # in these 2 perls.
# sub is_legacy_perl {
#     if ($] <= 5.008009) {
#         return 1;
